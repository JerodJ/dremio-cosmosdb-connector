...
@SourceType(value = "CosmosDBARP", label = "CosmosDB",uiConfig = "cosmosdb-layout.json")
public class CosmosDBConf extends AbstractArpConf<CosmosDBConf> {
  private static final String ARP_FILENAME = "arp/implementation/cosmosdb-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.cosmosdb.CosmosDBDriver";
